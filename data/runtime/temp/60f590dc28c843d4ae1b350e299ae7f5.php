<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:46:"./application/admin/template/arctype\index.htm";i:1541860348;s:67:"E:\project\www.yun.com\application\admin\template\public\layout.htm";i:1541056395;s:67:"E:\project\www.yun.com\application\admin\template\public\footer.htm";i:1525273455;}*/ ?>
<!doctype html>
<html>
<head>
              ...
              <tr>
                ...
                <th axis="col3" class="">
                  <div class="sundefined" style="padding-left: 15px">
                    <img src="/public/static/admin/images/tv-expandable.gif" id="all_treeclicked" title="关闭所有子栏目" style="float: none;" data-status="open" onClick="treeClicked(this,'all',0);">
                    栏目名称
                  </div>
                </th>
            ...
            <tr nctype="0" <?php if($vo['parent_id'] > 0): ?> style="display:none;"<?php endif; ?> class="parent_id_<?php echo $vo['parent_id']; ?>" data-level="<?php echo $vo['level']; ?>" data-id="<?php echo $vo['id']; ?>">
              ...
              <td>
                  <div class="w300 tl pb0">
                      ...
                      <?php if(is_check_access('Arctype@add') == '1'): if($vo['grade'] < ($arctype_max_level - 1)): ?>           
                        ...
                        <?php endif; endif; if(is_check_access('Arctype@del') == '1'): ?>
